...
public class Task019 {
    public static void main(String[] args) {
        System.out.println("Periodic Table elements and it's features");
        for(Element e : Element.values())
        {
            System.out.printf("%s : Label=%s | Atomic_Number = %d | Atomic Weight = %.3f%n",e.name(),
                    e.label,e.atomicNumber,e.atomicWeight);
        }
